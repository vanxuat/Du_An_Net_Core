...
{
    public partial class AspdotnetIdentityCore : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 8, 26, 22, 19, 22, 937, DateTimeKind.Local).AddTicks(6087)),
                    UserId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 8, 26, 22, 19, 22, 961, DateTimeKind.Local).AddTicks(3434), 100000m, 200000m, null });
